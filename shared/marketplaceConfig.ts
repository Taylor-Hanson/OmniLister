...
export const marketplaces: Record<string, MarketplaceConfig> = {
  ...
  mercari: {
    ...
    requiredCredentials: [
      { label: "API Key", key: "apiKey", type: "password", placeholder: "Enter your Mercari API key" },
      { label: "API Secret", key: "apiSecret", type: "password", placeholder: "Enter your Mercari API secret" },
    ],
    apiAvailable: true,
    popular: true,
  },
